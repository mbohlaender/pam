...
abstract class BaseNotePeer
{
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Title', 'Content', 'CreatedAt', 'ValidTo', 'Category', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'title', 'content', 'createdAt', 'validTo', 'category', ),
        BasePeer::TYPE_COLNAME => array (NotePeer::ID, NotePeer::USER_ID, NotePeer::TITLE, NotePeer::CONTENT, NotePeer::CREATED_AT, NotePeer::VALID_TO, NotePeer::CATEGORY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USER_ID', 'TITLE', 'CONTENT', 'CREATED_AT', 'VALID_TO', 'CATEGORY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'title', 'content', 'created_at', 'valid_to', 'category', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Title' => 2, 'Content' => 3, 'CreatedAt' => 4, 'ValidTo' => 5, 'Category' => 6, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'title' => 2, 'content' => 3, 'createdAt' => 4, 'validTo' => 5, 'category' => 6, ),
        BasePeer::TYPE_COLNAME => array (NotePeer::ID => 0, NotePeer::USER_ID => 1, NotePeer::TITLE => 2, NotePeer::CONTENT => 3, NotePeer::CREATED_AT => 4, NotePeer::VALID_TO => 5, NotePeer::CATEGORY => 6, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USER_ID' => 1, 'TITLE' => 2, 'CONTENT' => 3, 'CREATED_AT' => 4, 'VALID_TO' => 5, 'CATEGORY' => 6, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'title' => 2, 'content' => 3, 'created_at' => 4, 'valid_to' => 5, 'category' => 6, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(NotePeer::TITLE);
            $criteria->addSelectColumn(NotePeer::CONTENT);
            $criteria->addSelectColumn(NotePeer::CREATED_AT);
            $criteria->addSelectColumn(NotePeer::VALID_TO);
            $criteria->addSelectColumn(NotePeer::CATEGORY);
        } else {
