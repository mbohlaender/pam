...
abstract class BaseNote extends BaseObject implements Persistent
{
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[] = NotePeer::TITLE;
        }
    ...
    public function setValidTo($v)
    {
        ...
        if ($this->valid_to !== $v) {
            $this->valid_to = $v;
            $this->modifiedColumns[] = NotePeer::VALID_TO;
        }
    ...
    public function setCategory($v)
    {
        ...
        if ($this->category !== $v) {
            $this->category = $v;
            $this->modifiedColumns[] = NotePeer::CATEGORY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 7; // 7 = NotePeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NotePeer::USER_ID)) {
            $modifiedColumns[':p' . $index++]  = '`USER_ID`';
        }
        if ($this->isColumnModified(NotePeer::TITLE)) {
            $modifiedColumns[':p' . $index++]  = '`TITLE`';
        }
        if ($this->isColumnModified(NotePeer::CONTENT)) {
            $modifiedColumns[':p' . $index++]  = '`CONTENT`';
        }
        if ($this->isColumnModified(NotePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`CREATED_AT`';
        }
        if ($this->isColumnModified(NotePeer::VALID_TO)) {
            $modifiedColumns[':p' . $index++]  = '`VALID_TO`';
        }
        if ($this->isColumnModified(NotePeer::CATEGORY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NotePeer::TITLE)) $criteria->add(NotePeer::TITLE, $this->title);
        ...
        if ($this->isColumnModified(NotePeer::VALID_TO)) $criteria->add(NotePeer::VALID_TO, $this->valid_to);
        if ($this->isColumnModified(NotePeer::CATEGORY)) $criteria->add(NotePeer::CATEGORY, $this->category);
